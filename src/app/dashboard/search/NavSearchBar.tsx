  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <div className="flex items-center justify-center gap-1.5 text-muted-foreground md:mr-2 mr-0.5 md:border rounded-md hover:animate-appearance-in hover:opacity-60 p-2 cursor-pointer">
          <SearchIcon size={18} />

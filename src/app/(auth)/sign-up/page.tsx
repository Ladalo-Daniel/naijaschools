...
export default async function Home() {
  ...
  return (
    ...
    >
      <div className="flex mx-auto justify-center items-center min-h-screen w-full p-4 backdrop:fill-transparent backdrop-filter bg-black opacity-90 transition-all hover:from-black hover:to-green-500 hover:animate-pulse-plus"
      >
